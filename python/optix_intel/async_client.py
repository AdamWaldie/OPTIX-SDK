"""Asynchronous OPTIX client built on httpx.AsyncClient."""
...
from .errors import OptixNetworkError, classify_http_error
...
class AsyncOptixClient:
    """Async-flavoured equivalent of :class:`OptixClient`."""
    ...
    def __init__(
        ...
        *,
        ...
        if not api_key:
            raise ValueError("AsyncOptixClient requires an api_key")
    ...
    async def __aenter__(self) -> "AsyncOptixClient":
        return self
        ...
        *,
        ...
        while True:
            try:
                ...
                await asyncio.sleep(_t.backoff_seconds(attempt))
                attempt += 1
                continue
    ...
    async def paginate(
        ...
        *,
        ...
        while limit is None or yielded < limit:
            ...
            page = await self.request(operation, path_params=path_params, query=merged_query)
